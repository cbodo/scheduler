...
public class CustomerScheduleController implements Initializable {
     ...
     */
    public void init(ObservableList<Appointment> appointments, Customer customer) throws SQLException {
        scheduleTableView.setItems(appointments);
        customerLabel.setText(customer.getCustomerName() + "'s Schedule");
    }
