...
/**
 * This class handles the logic for displaying the current Month's appointments in the UI.
 */
public class MonthViewController implements Initializable {
    /**
     * TableView for the current month's appointments.
     */
    @FXML private TableView<Appointment> appointmentTableView;
    /**
     * Label to display the current month in the UI
     */
    ...
    public void init(MainViewController controller) throws SQLException {
        this.appointments = controller.getMonthData();
        appointmentTableView.setItems(this.appointments);
        controller.setMonthViewController(this);
        scheduleLabel.setText(LocalDateTime.now().getMonth().getDisplayName(TextStyle.FULL, Locale.getDefault()));
